...
Revision ID: 3de38667c519
Revises: 
Create Date: 2023-04-11 12:42:46.712953
...
def upgrade():
    ...
    sa.Column('fields_of_study', postgresql.ARRAY(sa.String(length=100)), nullable=False),
    ...
    sa.Column('diploma_number', sa.String(length=100), nullable=False),
    sa.Column('diploma_file_url', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['owner_id'], ['job_seeker.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
